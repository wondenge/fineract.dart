...
class GetPageItemsStandingInstructionSwagger {
  ...
  static List<GetPageItemsStandingInstructionSwagger> listFromJson(List<dynamic> json) {
    return json == null ? List<GetPageItemsStandingInstructionSwagger>() : json.map((value) => GetPageItemsStandingInstructionSwagger.fromJson(value)).toList();
  }

  static Map<String, GetPageItemsStandingInstructionSwagger> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, GetPageItemsStandingInstructionSwagger>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = GetPageItemsStandingInstructionSwagger.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of GetPageItemsStandingInstructionSwagger-objects as value to a dart map
  static Map<String, List<GetPageItemsStandingInstructionSwagger>> mapListFromJson(Map<String, dynamic> json) {
    var map = Map<String, List<GetPageItemsStandingInstructionSwagger>>();
     if (json != null && json.isNotEmpty) {
       json.forEach((String key, dynamic value) {
         map[key] = GetPageItemsStandingInstructionSwagger.listFromJson(value);
       });
     }
     return map;
  }
