...
class GetSelfSavingsAccountsAccountIdChargesSavingsAccountChargeIdResponse {
  ...
  @override
  String toString() {
    return 'GetSelfSavingsAccountsAccountIdChargesSavingsAccountChargeIdResponse[id=$id, chargeId=$chargeId, name=$name, chargeTimeType=$chargeTimeType, chargeCalculationType=$chargeCalculationType, percentage=$percentage, amountPercentageAppliedTo=$amountPercentageAppliedTo, currency=$currency, amount=$amount, amountPaid=$amountPaid, amountWaived=$amountWaived, amountWrittenOff=$amountWrittenOff, amountOutstanding=$amountOutstanding, amountOrPercentage=$amountOrPercentage, penalty=$penalty, ]';
  }

  GetSelfSavingsAccountsAccountIdChargesSavingsAccountChargeIdResponse.fromJson(Map<String, dynamic> json) {
    if (json == null) return;
    id = json['id'];
  ...
  static List<GetSelfSavingsAccountsAccountIdChargesSavingsAccountChargeIdResponse> listFromJson(List<dynamic> json) {
    return json == null ? List<GetSelfSavingsAccountsAccountIdChargesSavingsAccountChargeIdResponse>() : json.map((value) => GetSelfSavingsAccountsAccountIdChargesSavingsAccountChargeIdResponse.fromJson(value)).toList();
  }

  static Map<String, GetSelfSavingsAccountsAccountIdChargesSavingsAccountChargeIdResponse> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, GetSelfSavingsAccountsAccountIdChargesSavingsAccountChargeIdResponse>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = GetSelfSavingsAccountsAccountIdChargesSavingsAccountChargeIdResponse.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of GetSelfSavingsAccountsAccountIdChargesSavingsAccountChargeIdResponse-objects as value to a dart map
  static Map<String, List<GetSelfSavingsAccountsAccountIdChargesSavingsAccountChargeIdResponse>> mapListFromJson(Map<String, dynamic> json) {
    var map = Map<String, List<GetSelfSavingsAccountsAccountIdChargesSavingsAccountChargeIdResponse>>();
     if (json != null && json.isNotEmpty) {
       json.forEach((String key, dynamic value) {
         map[key] = GetSelfSavingsAccountsAccountIdChargesSavingsAccountChargeIdResponse.listFromJson(value);
       });
     }
     return map;
  }
