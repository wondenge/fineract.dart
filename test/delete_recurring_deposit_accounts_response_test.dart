...
// tests for DeleteRecurringDepositAccountsResponse
void main() {
    var instance = new DeleteRecurringDepositAccountsResponse();

  group('test DeleteRecurringDepositAccountsResponse', () {
