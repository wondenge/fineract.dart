...
// tests for PostSurveySurveyNameApptableIdResponse
void main() {
    var instance = new PostSurveySurveyNameApptableIdResponse();

  group('test PostSurveySurveyNameApptableIdResponse', () {
