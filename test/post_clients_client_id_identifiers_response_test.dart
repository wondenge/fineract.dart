...
// tests for PostClientsClientIdIdentifiersResponse
void main() {
    var instance = new PostClientsClientIdIdentifiersResponse();

  group('test PostClientsClientIdIdentifiersResponse', () {
